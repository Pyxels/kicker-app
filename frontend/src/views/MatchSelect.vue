<template>
  ...
  <div class="grid grid-cols-1 md:grid-cols-2 gap-6 w-full max-w-2xl">
    <div>
      ...
      <select v-model="selected.blue_attacker" class="w-full p-2 border rounded">
    ...
    <div>
      ...
      <select v-model="selected.blue_keeper" class="w-full p-2 border rounded">
        <option :value="null" disabled>Select player</option>
        <option v-for="user in users" :key="user.id" :value="user.id">
          {{ user.name }}
        </option>
    ...
    <div>
      ...
      <select v-model="selected.black_keeper" class="w-full p-2 border rounded">
        <option :value="null" disabled>Select player</option>
        <option v-for="user in users" :key="user.id" :value="user.id">
          {{ user.name }}
        </option>
    ...
    <div>
      ...
      <select v-model="selected.black_attacker" class="w-full p-2 border rounded">
        <option :value="null" disabled>Select player</option>
        <option v-for="user in users" :key="user.id" :value="user.id">
          {{ user.name }}
        </option>
  ...
  <button
    ...
    :class="isComplete ? 'bg-blue-600 hover:bg-blue-700' : 'bg-gray-400 cursor-not-allowed'"
    :disabled="!isComplete"
